...
export function StepBotIdentity({
	...
	const [botName, setBotName] = useState(initialBotName ?? "Papert Claw");
	...
	const previewBotName = botName.trim() || "Papert Claw";
	...
	return (
		<div className="w-full max-w-[480px]">
			...
			<p className="mb-6 text-sm text-muted-foreground">
				This information helps Papert Claw identify itself when responding to your team.
			</p>
