				...
				<SidebarMenu>
					<SidebarMenuItem>
						<SidebarMenuButton size="lg" className="pointer-events-none">
							<img src="/papert-logo.png" alt="Papert logo" className="size-7 rounded-md object-contain" />
							<div className="flex flex-col text-left group-data-[collapsible=icon]:hidden">
								<span className="text-base font-semibold tracking-tight">{identity?.botName ?? "Papert Claw"}</span>
								{identity?.orgName ? (
