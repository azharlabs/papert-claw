...
export function OnboardingPage({ initialSetupStatus }: { initialSetupStatus?: SetupStatus }) {
	...
	const [botName, setBotName] = useState(setupStatus.botName ?? "Papert Claw");
	const [draftOrganizationName, setDraftOrganizationName] = useState(setupStatus.orgName ?? "");
	const [draftBotName, setDraftBotName] = useState(setupStatus.botName ?? "Papert Claw");
	...
	const [llmProvider, setLlmProvider] = useState<"openai">(setupStatus.llmProvider ?? "openai");
	...
	return (
		<div className="flex min-h-screen flex-col items-center justify-center px-4 py-8">
			<div className="mb-8 flex flex-col items-center gap-2">
				<img src="/papert-logo.png" alt="Papert logo" className="size-9 rounded-md object-contain" />
				<span className="text-lg font-semibold tracking-tight">Papert Claw</span>
			</div>
